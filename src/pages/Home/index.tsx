    ...
    <>
      <section className="flex flex-col justify-center sm:h-[calc(100vh-340px)] px-5 pt-12 sm:pt-0 mb-24 sm:mb-0">
        <div className="text-4xl text-faded-text mb-7 font-semibold">
          ...
          <br />a software engineer and a tech enthusiast from Republic of
          Moldova. Currently working for{" "}
          <Link
            className="link link__orange"
            to="https://www.globallogic.com/"
            target="_blank"
          >
            GlobalLogic.
          </Link>{" "}
        ...
        <div className="text-faded-text font-semibold text-[21.6px] leading-[1.3]">
          ...
          <Link
            ...
            to="https://lorenzo-ap.github.io/weather-app/"
            target="_blank"
          >
            Weather App
          </Link>{" "}
          ...
          <Link
            className="link link__blue"
            to="https://lorenzo-typing-game.vercel.app/"
            target="_blank"
          >
            Typing Game
          </Link>
