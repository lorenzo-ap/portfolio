...
export const Footer = () => {
	...
	useEffect(() => {
		...
		if (storedTheme) {
			setIsDarkModeSelected(storedTheme === Theme.Dark);
			return;
		}
	...
	return (
		<footer>
			<div className='mx-6 mb-[50px] flex items-center justify-between border-faded-line border-t-[1px] pt-[14px]'>
					...
					<div className='flex rounded-md bg-faded-bg'>
						...
						>
							<svg height='16' strokeLinejoin='round' viewBox='0 0 16 16' width='16'>
								<title>{t('footer.lightMode')}</title>
								<path
									clipRule='evenodd'
